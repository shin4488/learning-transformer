...
前章までで、Transformerという仕組みがどう作られ(第8〜9章)、どう訓練され(第10章)、どう対話AIに仕立てられるか(第12章)を見てきました。この章では視点を変えて、「**なぜ近年のAIは、こんなに急に賢くなったのか**」という問いに答えます。答えを一言でいえば「**大きくしたから**」なのですが、その裏には意外なほど整然とした法則が隠れています。
...
ただし、これはあくまで直感的な説明です。「巨大モデル + 巨大データならうまくいく」ことが**事前に理論から予言されていたわけではなく**、実験してみたら意外なほど規則正しくうまくいった、というのが歴史の実際です。その「意外なほど規則正しい」部分を定量化したのが、これから見るスケーリング則です。
