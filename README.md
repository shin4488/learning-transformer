...
> [!NOTE]
> 本書の図は Mermaid 記法を基本とし、構成図はフローチャート、関数のグラフや確率分布は折れ線・棒グラフ(xychart)で描いています。ベクトルの矢印や散布図など Mermaid で表現しにくい図は画像で、行列のレイアウトなど一部の図はテキストの図で載せています。数式は LaTeX 記法(`$$ ... $$`)で、数式として表示されます。
